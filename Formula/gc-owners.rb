...
class GcOwners < Formula
  ...
  url "https://github.com/gocardless/codeowners/releases/download/v0.0.3/codeowners_0.0.3_darwin_amd64.tar.gz", using: Gc::GithubPrivateReleaseDownloadStrategy
  version "0.0.3"
